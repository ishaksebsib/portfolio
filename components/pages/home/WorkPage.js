      ...
      <div className="flex justify-center items-center md:mx-24 lg:mx-32">
        ...
        >
          <div className=" mx-16 my-6 md:col-span-2 md:mx-0">
            <h1 className="text-2xl smallerwork text-mediumer md:text-4xl ">
              RECENT WORKS
            </h1>
            <p className="text-4xl my-3 smallerwork text-slate-500 font-light md:max-w-4xl md:text-5xl md:text-left md:font-thin">
              Here are some of my projects i did lately. Feel free to check them
              out.
            </p>
          </div>
          <div className=" smallerwidth w-[80%] mx-16 rounded-lg transition hover:-translate-y-2 md:mx-0 md:w-auto ">
